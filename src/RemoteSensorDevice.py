...
class RemoteIOSensorChannel():
    ...
    def __init__(self, io_line : IOLine, name, state_topic, raw_adc_value_topic, qos: int, device_class: str):
...
class ADCBinarySensorChannel(RemoteIOSensorChannel):
    ...
    def __init__(self, io_line : IOLine, name, state_topic, raw_adc_value_topic, qos, device_class, threshold, greater_than_value : bool):
        super().__init__(io_line, name, state_topic, raw_adc_value_topic, qos, device_class)
